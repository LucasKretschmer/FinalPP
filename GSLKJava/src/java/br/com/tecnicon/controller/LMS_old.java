 ...
 * @author sipmann
 */
@WebServlet(name = "LMS_OLD", urlPatterns =
{
    "/LMS_OLD/*", "/lms_old/*"
})
public class LMS_old extends HttpServlet
{
        ...
        if (request.getParameter("acao") == null)
        {
            ...
            try (PrintWriter out = response.getWriter())
            {
                ...
                try
                {
                    ...
                    Object objeto = TecniconLookup.lookup("LMSCurso", "LMSHome");
