...
/**
 *
 * @author luciana.ruaro
 */
@WebServlet(name = "COTACAOFRETE", urlPatterns =
{
    "/COTACAOFRETE"
})
public class ControllerCotacaoFrete extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
        ...
        try
        {
            ...
            if (request.getParameter("SFRETECOTADO") == null && request.getParameter("s") != null)
            {
                try
                {
                    ...
                    mp.put("SFRETECOTADO", new String[]
                    {
                        cbanner
                    });
            ...
            } else
            {
                mp.put("SFRETECOTADO", new String[]
                {
                    request.getParameter("SFRETECOTADO")
                });
            }
            ...
            Object obj = TecniconLookup.lookup("FretesCotados", "FretesCotados");
            String conteudo = (String) obj.getClass().getMethod("geraHTMLCotacao", VariavelSessao.class).invoke(obj, vs);
