 ...
 */
@WebServlet(name = "Representante", urlPatterns =
{
    "/Representante"
})
public class Representante extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
        ...
        {
            response.sendRedirect("/Tecnicon/indexRepresentante.html");
        }
        else
        {
...
//                        sessao = a.get(0);
            ...
            else
            {
                try
                {
                    out.println(Index.retornaIndex(dispositivo, navegadordelphi, tipoacesso, navegadorswing, "representante", request));
                    out.close();
                }
                catch (ExcecaoTecnicon ex)
                {
