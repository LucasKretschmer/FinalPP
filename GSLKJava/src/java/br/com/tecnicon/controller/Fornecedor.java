 ...
 */
@WebServlet(name = "Fornecedor", urlPatterns =
{
    "/Fornecedor"
})
public class Fornecedor extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
        ...
        {
            response.sendRedirect("/Tecnicon/indexFornecedor.html");
        }
        else
        {
...
//                        sessao = a.get(0);
            ...
            else
            {
                try
                {
                    out.println(Index.retornaIndex(dispositivo, navegadordelphi, tipoacesso, navegadorswing, "fornecedor", request));
                    out.close();
                }
                catch (ExcecaoTecnicon ex)
                {
